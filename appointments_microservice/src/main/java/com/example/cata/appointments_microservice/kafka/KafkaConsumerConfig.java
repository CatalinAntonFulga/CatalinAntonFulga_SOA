package com.example.cata.appointments_microservice.kafka;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, AppointmentEvent> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(configProps, new StringDeserializer(), new JsonDeserializer<>(AppointmentEvent.class));
    }
